      ...
      <p>
        ...
        <ul>
          ...
          <li>
            ...
            app. It was used to solve a popular puzzle game at the time called "4 pics one word". I wrote a python
            script to take a dictionary file and split it up into various files and folders based on the lenght of the
            word and the letter is started with. I think this was so I didn't have to load the whole dictionary at once?
            It also included an <code>addWord.htm</code> page where users could add missing words to the dictionary
            (through a php script that just appends to a txt file...)
          </li>
        </ul>{' '}
      </p>
